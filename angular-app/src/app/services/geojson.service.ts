...
export class GeoJsonService implements OnDestroy {
  ...
  public clickEvent$: Observable<{ latitude: number; longitude: number; id: string; isShiftClick?: boolean } | null> =
    this.clickEventSubject.asObservable()

  private selectedFeatureSubject = new BehaviorSubject<{ latitude: number; longitude: number; id: string; quality: string } | null>(null)
  public selectedFeature$: Observable<{ latitude: number; longitude: number; id: string; quality: string } | null> =
    this.selectedFeatureSubject.asObservable()
  ...
  private modifyBuildingSubject = new BehaviorSubject<{
    coordinates: number[]
    latitude: number
    longitude: number
    ubid: string
  ...
  public modifyBuilding$: Observable<{ coordinates: number[]; latitude: number; longitude: number; ubid: string; id: string } | null> =
    this.modifyBuildingSubject.asObservable()
