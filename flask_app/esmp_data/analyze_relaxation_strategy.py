...
def analyze_current_strategy_effectiveness():
    ...
    test_combinations = [combo for combo in all_combinations if combo not in combinations_with_eui]
    ...
    overall_success = (
        tier_results["tier_1_exact"]
        + tier_results["tier_2_relax_hours"]
        + tier_results["tier_3_relax_hours_year"]
        + tier_results["tier_4_relax_hours_year_gfa"]
    )
