...
class TestFootprintService(unittest.TestCase):
    ...
    def test_process_ms_footprints(self, mock_centroid, mock_encode_ubid):
        ...
        self.assertIn("ms_footprint_area_m2", result.columns)
        self.assertIn("ms_footprint_area_ft2", result.columns)
    ...
    def test_process_osm_footprints(self, mock_centroid, mock_encode_ubid):
        ...
        self.assertIn("lat", result.columns)
        self.assertIn("lon", result.columns)
        self.assertIn("osm_footprint_area_m2", result.columns)
        self.assertIn("osm_footprint_area_ft2", result.columns)
